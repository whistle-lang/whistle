...
impl TryFrom<&str> for Keyword {
  ...
  fn try_from(keyword: &str) -> Result<Self, Self::Error> {
    match keyword {
      ...
      "number" => Ok(Keyword::Primitive(Primitive::I32)),
      "int" => Ok(Keyword::Primitive(Primitive::I32)),
      "float" => Ok(Keyword::Primitive(Primitive::F64)),
...
impl From<Keyword> for &str {
  fn from(val: Keyword) -> Self {
    match val {
      ...
      Keyword::Primitive(Primitive::Number) => "number",
